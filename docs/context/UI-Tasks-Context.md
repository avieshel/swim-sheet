...
**Solution**:
- **`client/src/constants/index.ts`** — `QUICK_SESSION_TEMP_SWIMMER_THRESHOLD = 15` (configurable), exposed via `api/constants.quickSessionTempSwimmerThreshold()`.
