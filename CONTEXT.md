Context documentation has moved to `docs/context/`.

See:
- [`docs/context/App-Context.md`](docs/context/App-Context.md) — architecture, tech stack, project overview
- [`docs/context/DB-Context.md`](docs/context/DB-Context.md) — data model, offline-first design, sync
